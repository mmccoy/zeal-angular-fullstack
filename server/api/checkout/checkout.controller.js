...
function createOrder(data, transaction) {
  ...
  client.sendEmailWithTemplate({
    ...
    "TemplateModel": {
      ...
      "colorAccentHex": stick.customColor.accent.hex,
      "colorAccentName": stick.customColor.accent.name,
      "colorLogoHex": stick.customColor.logo.hex,
      "colorLogoName": stick.customColor.logo.name,
      "flex": stick.flex,
      "blade": stick.pattern,
...
export function create(req, res) {
  ...
  gateway.transaction.sale({
    ...
    customFields: {
      ...
      stick_colors: 'Shaft: ' + cartData.items[0]._data.customColor.shaft.name + ', Logo: ' + cartData.items[0]._data.customColor.logo.name + ', Accents: ' + cartData.items[0]._data.customColor.accent.name,
